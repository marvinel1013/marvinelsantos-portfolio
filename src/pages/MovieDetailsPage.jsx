...
import { movieAppImgData } from "../data/ProjectData";
import CoverPhoto from "../assets/projects-screen-shot/movie-app/cover.png";
        ...
        <div className="mt-5 md:mt-10 flex md:flex-row flex-col items-center justify-between">
          <div>
            ...
            <p className="md:mt-5 mt-2 text-sm md:text-base md:w-[550px]">
              In this project, I created the Simple Movie Application in React
              JS plus Vite. I used Tailwind CSS for styling. I also used
              Material UI to the Pagination and Headless UI in the Modal
              component TMDb API as my API.In this Movie App you can see the
              Weekly Trending and also have a movies page, Tv Series page and a
              Search page. You can watch the trailer by clicking the See Details
              button in the Movie Card the modal will appear and click watch
              trailer button and the app will open the trailer via youtube in
              new tab of the browser. You can also change the Theme to Darkmode
              to Lightmode its Darkmode by default. This Application is hosted
              in Netlify.
            </p>
            <div className="flex text-indigo-700 dark:text-primary items-center gap-4 md:gap-8 my-4 md:mt-8 text-sm md:text-base">
              <a
                href="https://github.com/marvinel1013/Movie-App"
                target={"_blank"}
              >
              ...
              <a
                href="https://simple-movie-app-by-marvinel.netlify.app/"
                target={"_blank"}
              >
                <span className="flex items-center gap-2 p-3 shadow-md shadow-black hover:scale-110 duration-300 ease-in cursor-pointer rounded-md">
                  Demo
