...
import { portfolioAppImgData } from "../data/ProjectData";
import CoverPhoto from "../assets/projects-screen-shot/portfolio-app/cover.png";
...
function PortfolioDetailsPage() {
  ...
  return (
    <div className="min-h-screen w-full text-dark dark:text-light dark:bg-dark bg-light">
      <div className="w-full h-[30vh] md:h-[40vh] relative bg-black">
        <img
          src={CoverPhoto}
          alt="cover-photo"
