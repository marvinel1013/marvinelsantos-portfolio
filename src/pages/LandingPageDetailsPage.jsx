...
function LandingPageDetailsPage() {
  ...
  const techData = ["React JS", "JavaScript", "Vite", "Tailwind CSS"];
        ...
        <div className="mt-5 md:mt-10 flex md:flex-row flex-col items-center justify-between">
          <div>
            ...
            <p className="md:mt-5 mt-2 text-sm md:text-base md:w-[550px]">
              In this project, I created a Landing Page Application with smooth
              animation. I created it in React JS, Vite and Tailwind CSS as my
              CSS framework. This porject is only a UI Design with no
              functionality only the smooth scrool in every navlink and the
              animated on scroll this application is fully responsive. I created
              this project to enhance my skill in Tailwind CSS. This application
              is hosted in Vercel.
            </p>
            <div className="flex text-indigo-700 dark:text-primary items-center gap-4 md:gap-8 my-4 md:mt-8 text-sm md:text-base">
              <a
                href="https://github.com/marvinel1013/Landing-Page-App"
                target={"_blank"}
              >
              ...
              <a
                href="https://landing-page-by-marvinel.vercel.app/"
                target={"_blank"}
              >
                <span className="flex items-center gap-2 p-3 shadow-md shadow-black hover:scale-110 duration-300 ease-in cursor-pointer rounded-md">
                  Demo
...
export default LandingPageDetailsPage;
